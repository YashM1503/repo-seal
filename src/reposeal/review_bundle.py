...
REVIEW_SCOPE_PATHS: tuple[str, ...] = (
    ...
    "docs/adr/0005-public-apache-release.md",
    "docs/adr/0006-reposeal-rename.md",
    ...
    "examples/evidence-set/parser-fix.json",
    "examples/evidence-set/payment-fix.json",
    "pyproject.toml",
    "src/reposeal/__init__.py",
    "src/reposeal/__main__.py",
    "src/reposeal/agent_boundary.py",
    "src/reposeal/controlled.py",
    "src/reposeal/controlled_agent.py",
    "src/reposeal/docker_backend.py",
    "src/reposeal/evidence.py",
    "src/reposeal/falsification.py",
    "src/reposeal/isolation.py",
    "src/reposeal/isolation_probe.py",
    "src/reposeal/mock_agent.py",
    "src/reposeal/replay.py",
    "src/reposeal/review_bundle.py",
    "src/reposeal/schemas.py",
    "src/reposeal/version.py",
