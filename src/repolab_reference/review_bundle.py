...
REVIEW_SCOPE_PATHS: tuple[str, ...] = (
    ...
    "pyproject.toml",
    "src/repolab_reference/__init__.py",
    "src/repolab_reference/__main__.py",
    "src/repolab_reference/agent_boundary.py",
    "src/repolab_reference/controlled.py",
    "src/repolab_reference/controlled_agent.py",
    "src/repolab_reference/docker_backend.py",
    "src/repolab_reference/falsification.py",
    "src/repolab_reference/isolation.py",
    "src/repolab_reference/isolation_probe.py",
    "src/repolab_reference/mock_agent.py",
    "src/repolab_reference/replay.py",
    "src/repolab_reference/review_bundle.py",
    "src/repolab_reference/schemas.py",
